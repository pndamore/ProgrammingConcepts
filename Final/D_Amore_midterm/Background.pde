class Stars {
  ...
  Stars(){
    ...
    tint = color(random(192, 255), random(192, 255), random(192, 255), 255 / (2 * position.z + 1));
  }
  ...
  void display(){
    ...
    fill(tint); 
    ellipse(position.x, position.y, sizeMultiplier * diameter, sizeMultiplier * diameter + 0.5 * velocity);
  }
}